...
#' Creating a new class of Geom to specifies a number of attributes and
#' functions that describe how data should be drawn on a plot.
#'
#' @param GeomHurricane This is the Geom name created to perform my needs
#'
#' @param required_aes a character vector of required aesthetics
#'
#' @param default_aes default values for certain aesthetics
#'
#' @param draw_key a function used to draw the key in the legend
#'
#' @param draw_group Function used to manipulate the data
#'
